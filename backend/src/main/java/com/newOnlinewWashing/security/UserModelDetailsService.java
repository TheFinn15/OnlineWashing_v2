...
public class UserModelDetailsService implements UserDetailsService {
   ...
   public UserModelDetailsService(PersonRepo userRepository) {
   ...
   private org.springframework.security.core.userdetails.User createSpringSecurityUser(String lowercaseLogin, Person user) {
      if (!user.isActivated()) {
